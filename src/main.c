O próximo diagnóstico será especificamente:
...
mpv evento
   ↓
vídeo realmente abriu?
   ↓
vídeo tem frames?
   ↓
render callback recebeu atualização?
   ↓
FBO 0 é realmente o framebuffer correto?
   ↓
mpv está desenhando no framebuffer do GtkGLArea?
```

Esse é o próximo nível do diagnóstico.


vamos impedir que o GTK tente tratar o argumento como arquivo.
...
Mas há uma solução ainda melhor para o nosso caso: **não precisamos passar o caminho
diretamente ao `g_application_run()`**. Podemos separar os argumentos antes de chamar o
GTK.
...
Então o próximo teste deve começar com:

```text
[MAIN] arquivo = /home/segodimo/videos/tst1.mp4
```

e depois esperamos:

```text
[MPV] carregando: /home/segodimo/videos/tst1.mp4
[MPV] loadfile ... -> 0
```

A partir daí podemos verificar se **o mpv realmente decodificou o primeiro frame**. Esse
é o próximo ponto importante — a criação do contexto OpenGL e do `mpv_render_context` já
está funcionando.

```bash
➜  06gpiv make                                 
gcc -Wall -Wextra -g -I/usr/include/gtk-4.0 -I/usr/include/pango-1.0 -I/usr/include/fribidi -I/usr/include
/harfbuzz -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/glycin-2 -I/usr/include/cairo -I/usr/include/freety
pe2 -I/usr/include/libpng16 -I/usr/include/pixman-1 -I/usr/include/graphene-1.0 -I/usr/lib/graphene-1.0/in
clude -mfpmath=sse -msse -msse2 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/libmoun
t -I/usr/include/blkid -I/usr/include/sysprof-6 -pthread src/main.c -o gpiv -lgtk-4 -lpangocairo-1.0 -lpan
go-1.0 -lharfbuzz -lgdk_pixbuf-2.0 -lcairo-gobject -lcairo -lvulkan -lgraphene-1.0 -lgio-2.0 -lgobject-2.0
 -lglib-2.0 -lmpv -lepoxy -lGL
➜  06gpiv ./gpiv /home/segodimo/videos/tst1.mp4
[MAIN] LC_NUMERIC = C
[MAIN] arquivo = /home/segodimo/videos/tst1.mp4
[gtk] ACTIVATE
[gtk] chamando gtk_window_present()
[window] REALIZE
[window] visible=1 mapped=0
[window] size=0x0
[gl-area] realized=0 mapped=0 visible=1 size=0x0
[GL] REALIZE GtkGLArea
[GL] contexto OpenGL criado
[GL] vendor   = AMD
[GL] renderer = AMD Radeon RX 6600 (radeonsi, navi23, ACO, DRM 3.64, 6.18.42-1-lts)
[GL] version  = 4.6 (Core Profile) Mesa 26.1.6-arch1.1
[MPV] LC_NUMERIC antes = pt_BR.UTF-8
[MPV] LC_NUMERIC depois = C
[MPV] chamando mpv_create()
[MPV] mpv_create() OK
[MPV] mpv_initialize() OK
[MPV-RENDER] criando mpv_render_context
Cannot load libcuda.so.1
[MPV-RENDER] mpv_render_context criado: 0x55bce1f856e0
[MPV] UPDATE -> queue_render()
[MPV-RENDER] update callback registrado
[MPV] carregando arquivo: /home/segodimo/videos/tst1.mp4
[MPV] loadfile enviado com sucesso
[window] MAP
[window] visible=1 mapped=1
[window] size=0x0
[gl-area] realized=1 mapped=1 visible=1 size=0x0
[gtk-resize] size=1916x988
[gtk-render] RENDER mpv=0x55bce1ee2870 render=0x55bce1f856e0
[gtk-render] viewport=1916x988
[MPV-RENDER] render OK
[gtk-resize] size=1916x966
[gtk-render] RENDER mpv=0x55bce1ee2870 render=0x55bce1f856e0
[gtk-render] viewport=1916x966
[MPV-RENDER] render OK
[gtk-render] RENDER mpv=0x55bce1ee2870 render=0x55bce1f856e0
[gtk-render] viewport=1916x966
[MPV-RENDER] render OK
